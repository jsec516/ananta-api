...
@section('form')
	...
	<div class="row">
		...
		<div class="input-field col s12 login-actions">
			...
			<a href="{{ route('register') }}" class="waves-effect waves-light btn btn-primary"><i class="material-icons left">person_add</i> REGISTER</a>
		</div>
	</div>
	{!! Former::close() !!}
@endsection
...
@section('additional_link')
	Already have password? Please click <a href="{{ route('login') }}" class="white-text darken-3-text u b">here</a> to login.
@endsection