<header>
	<nav class="blue darken-4">
		<div class="nav-wrapper">
			<ul class="left">
				<li class="no-hover">
					<a href="#" data-activates="slide-out" class="menu-sidebar-collapse btn-floating btn-flat btn-medium waves-effect waves-light blue darken-4">
						<i class="mdi-navigation-menu"></i>
					</a>
				</li>
				<li>
					<a href="index.html" class="brand-logo darken-1">
						<span class="logo-text">Qclinic</span>
					</a>
